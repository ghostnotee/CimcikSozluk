namespace CimcikSozluk.Common.Models.Page;
...
public class Page
{
    ...
    {
        if (currentPage < 1) throw new ArgumentException("Invalid page number!");
        if (pageSize < 1) throw new ArgumentException("Invalid page size!");
